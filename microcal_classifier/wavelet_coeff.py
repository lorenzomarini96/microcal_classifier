...
def dwt_analysis(image, wavelet, level):
    ...
    Computing the standard deviation for each matrix (image and coefficients),
    ...
    # mode = 'hard': In hard thresholding, the data values where their
    # absolute value is less than the value param are replaced with substitute.
